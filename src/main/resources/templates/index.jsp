                    ...
                    $.each(data, function (k, v) {
                        if (!v.flags.maker) {
                            $("#tradeHistoryTable tbody").append(
                                ...
                                ((!v.jupiterTx && v.icon !== undefined) ? "<img src=\"static/entities/" + v.icon + ".png\" width=16 height=16 style=\"margin-right: 6px;\">" : "") +
                                (v.normalTx ? "<a href=\"https://solscan.io/tx/" + v.normalTx + "\" target=_blank>" : "") +
